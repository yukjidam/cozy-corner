...
const GENRES={
  chill:{label:'🌙 chill lofi',tracks:[
    {title:'midnight walk',artist:'lofi dreamer',dur:'3:12',src:''},
    {title:'soft rain window',artist:'cozyhop',dur:'2:58',src:''},
    {title:'sleepy city',artist:'nightowl beats',dur:'3:40',src:''},
    {title:'lavender hour',artist:'pastel sounds',dur:'3:05',src:''},
    {title:'dim light café',artist:'lofi dreamer',dur:'2:45',src:''},
  ]},
  study:{label:'📚 study lofi',tracks:[
    {title:'focus flow',artist:'study.wav',dur:'3:28',src:''},
    {title:'library at 2am',artist:'deep work co.',dur:'4:01',src:''},
    {title:'coffee & pages',artist:'study.wav',dur:'3:15',src:''},
    {title:'deadline mode',artist:'brainfuel beats',dur:'3:52',src:''},
    {title:'quiet hours',artist:'deep work co.',dur:'2:59',src:''},
  ]},
  jazz:{label:'🎷 jazz lofi',tracks:[
    {title:'smoke & vinyl',artist:'jazzcat records',dur:'4:10',src:''},
    {title:'late night improv',artist:'trio nuance',dur:'3:48',src:''},
    {title:'blue note kitchen',artist:'jazzcat records',dur:'3:33',src:''},
    {title:'autumn standard',artist:'quartet soft',dur:'4:22',src:''},
    {title:'sunday paper',artist:'trio nuance',dur:'3:07',src:''},
  ]},
  hiphop:{label:'🎤 hip hop lofi',tracks:[
    {title:'corner store groove',artist:'beatsmith 88',dur:'2:55',src:''},
    {title:'sample flip no. 4',artist:'crate digger',dur:'3:18',src:''},
    {title:'golden era vibes',artist:'beatsmith 88',dur:'3:44',src:''},
    {title:'headnod season',artist:'dusty wax co.',dur:'2:50',src:''},
    {title:'lo frequency',artist:'crate digger',dur:'3:30',src:''},
  ]},
  picks:{label:'⭐ personal picks',tracks:[
    {title:'Ice Cream',artist:'YUNA',dur:'2:51',src:'assets/personal/YUNA - Ice Cream.mp3',thumb:'assets/thumbnail/YUNA - Ice Cream.jpg'},
    {title:'Heat Waves',artist:'Glass Animals',dur:'2:55',src:'assets/personal/Glass Animals - Heat Waves.mp3',thumb:'assets/thumbnail/Glass Animals - Heat Waves.jpg'},
    {title:'Sunflower',artist:'Post Malone, Swae Lee',dur:'2:41',src:'assets/personal/Post Malone, Swae Lee - Sunflower.mp3',thumb:'assets/thumbnail/Post Malone, Swae Lee - Sunflower.jpg'},
  ]}
};
...
function loadTrack(genre,index,autoplay){
  ...
  if(t.thumb){
    playerThumbEl.innerHTML=`<img src="${t.thumb}" alt="${t.title}" style="width:100%;height:100%;object-fit:cover;">`;
    miniThumbEl.innerHTML=`<img src="${t.thumb}" alt="${t.title}" style="width:100%;height:100%;object-fit:cover;">`;
  } else {
